package dev.cobblesword.libraries.common.messages;
...
public class CC
{
	...
	public static String info(String header, String message) {
		return CC.darkGray + header + " " + CC.bAqua + "?" + " " + CC.gray + message;
	}

	public static String success(String header, String message) {
		return CC.darkGray + header + " " + CC.green + CC.thickCheck + " " + CC.gray + message;
	}

	public static String error(String header, String message) {
		return CC.darkGray + header + " " + CC.red + CC.thickCross + " " + CC.gray + message;
	}
